...
function isKnownApplicationPath(pathname: string): boolean {
  if (pathname === '/login' || pathname === '/signup' || pathname === '/admin' || pathname === '/account/profile' || pathname === '/account/sessions' || pathname === '/account/notifications' || pathname === '/organisation/settings') return true;
